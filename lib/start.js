...
internals.manifest = {
    ...
    registrations: [
        ...
        {
          plugin: {
              register: 'hapi-sequelizejs',
              options: [
                  {
                      name: 'db',    //identifier
                      models: [__dirname + '/sequelize/models/**/*.js'],  // paths/globs to model files 
                      sequelize: new Sequelize('sequelize-demo','postgres', 'Coast', {
                        host: 'localhost',
                        dialect: 'postgres',
                        pool: {
                          max: 5,
                    ...
                    //   forceSynce: false     // force sync (drops tables) - default false
                    onConnect: function (database) { // Optional
                        console.log('db Connection has been established successfully!.');
                        console.log(database.models.User);
                        // database.models.User.findById(1).then(users => {
